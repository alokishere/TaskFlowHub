      ...
      <nav className="flex-1 space-y-1">
        ...
        <div>
          <button 
            ...
            className={`w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl transition-all font-medium ${
              location.pathname.includes('/admin/employees') ? 'text-purple-600 bg-purple-50/30' : 'text-gray-500 hover:bg-gray-50'
            }`}
          >
        ...
        <div>
          <button 
            ...
            className={`w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl transition-all font-medium ${
              location.pathname.includes('/admin/projects') ? 'text-purple-600 bg-purple-50/30' : 'text-gray-500 hover:bg-gray-50'
            }`}
          >
            <div className="flex items-center gap-3">
              <Briefcase size={20} />
            ...
            <ChevronDown size={16} className={`transition-transform duration-300 ${openMenus.projects ? 'rotate-180' : ''}`} />
          </button>
